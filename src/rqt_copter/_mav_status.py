...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3iB4If.pack(_x.gps_num_satellites, _x.debug1, _x.debug2, _x.have_SSDK_parameters, _x.tx_packets, _x.tx_packets_good, _x.rx_packets, _x.rx_packets_good, _x.timesync_offset))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps_num_satellites, _x.debug1, _x.debug2, _x.have_SSDK_parameters, _x.tx_packets, _x.tx_packets_good, _x.rx_packets, _x.rx_packets_good, _x.timesync_offset,) = _struct_3iB4If.unpack(str[start:end])
